...
class InstitutionRepositoryFactory implements FactoryInterface
{
    /*
     * (non-PHPdoc)
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $meta   = $em->getClassMetadata('Admin\Entity\Academic\Institution');
        return new InstitutionRepository($em, $meta);
    }
}
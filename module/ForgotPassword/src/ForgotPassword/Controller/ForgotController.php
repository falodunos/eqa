            ...
            if ( $form->isValid())
            {
                ...
                if($user != null) {
                    ...
                    return new JsonModel([
                        'status' => true,
                        'message' => 'Password reset link had been sent to the following e-mail address ('.$email.').',
                        'email' => $email
                    ]);
                }else{
                    return new JsonModel([
                        'status' => false,
                        'message' => 'The e-mail address ('.$email.') was not found in our database, please check your spellings.' ,
                        'email' => $email
                    ]);
                }
            } else {

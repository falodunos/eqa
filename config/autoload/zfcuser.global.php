...
$settings = array(
    ...
    'operation_admin_user_role' => 'operation-admin',
    'super_admin_user_role' => 'super-admin',
    'root_admin_user_role'  => 'root-admin',
    /**
	 ...
	 */
   'user_login_widget_view_template' => 'application/widget/form/user/login.phtml',//'zfc-user/user/login.phtml',

 ...
 */
class Type extends \Admin\Entity\Question\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'typeName', 'typeDescription', 'institution', 'department', 'id', 'createdAt', 'updatedAt', 'isActive');
        }
    ...
    public function setTypeDescription($typeDescription)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeDescription', array($typeDescription));

...
namespace DoctrineORMModule\Proxy\__CG__\Admin\Entity\Exam;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Month extends \Admin\Entity\Exam\Month implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'questionPaper', 'examMonth', 'id', 'createdAt', 'updatedAt', 'isActive');
        }

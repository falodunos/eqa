...
class User extends EventProvider implements ServiceManagerAwareInterface
{
    ...
    public function register(array $data)
    {
        ...
        $user->setCreatedAt($dateTime)->setUpdatedAt($dateTime)->setIsActive('1');
        ...
        $this->onRegister($user); //temporary hack done here : the register and register.post events seems not dispatch or not caugth
    ...
    public function onRegister($user)
    {
        ...
        $defaultUserRole = $em->getRepository('Application\Entity\Role')->findOneBy($criteria);
